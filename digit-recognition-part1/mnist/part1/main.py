...
# print('Linear Regression test_error 1 =', run_linear_regression_on_MNIST(lambda_factor=1))
# print('Linear Regression test_error 0.1 =', run_linear_regression_on_MNIST(lambda_factor=0.1))
# print('Linear Regression test_error 0.01 =', run_linear_regression_on_MNIST(lambda_factor=0.01))
...
print('softmax current model test_error=', run_softmax_on_MNIST(temp_parameter=1))
