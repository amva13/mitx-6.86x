...
def hinge_loss_single(feature_vector, label, theta, theta_0):
    ...
    Returns:
        ...
        parameters.
    """
    return max(0, 1 - np.dot(label,(theta_0 + np.dot(theta,feature_vector))))
...
def classifier_accuracy(
    ...
    """
    t,t0 = classifier(train_feature_matrix, train_labels, **kwargs)
    tacc = accuracy(classify(train_feature_matrix, t, t0), train_labels)
    vacc = accuracy(classify(val_feature_matrix, t, t0), val_labels)
    return tacc, vacc
